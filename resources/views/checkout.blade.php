        ...
        <div class="checkout_container-main">
                ...
                <h5>Пожалуйста, заполните поля ниже:</p>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="country" class="form-control" id="street" aria-describedby="StreetHelp">
                        <small id="street" class="form-text text-muted">Введите вашу страну</small>
                    </div>
                    <div class="form-group">
                        <label for="town/sity">Город*</label>
                        <input type="text" name="city" class="form-control" id="town" aria-describedby="town">
                        <small id="town" class="form-text text-muted">Введите ваш город</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputStreet">Район улица*</label>
                        <input type="text" name="street" class="form-control" id="street" aria-describedby="StreetHelp">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="postcode" class="form-control" id="postcode/zip" aria-describedby="postcode/zip">
                        <small id="postcode/zip" class="form-text text-muted">Введите Почтовый индекс / ZIP</small>
                    </div>
                    <div class="form-group">
                        <label for="phone">Номер телефона*</label>
                        <input type="text" name="phone" class="form-control" id="phone" aria-describedby="phone" required>
...
{{--             <h3>Ваши заказы</h3>
            ...
            <button type="submit" style="cursor:pointer;" class="checkout_button">Заказать</button>
        </div>
